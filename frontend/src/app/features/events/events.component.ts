...
@Component({
  ...
  template: `
      <div class="events-page">
        ...
        <div class="svs-card events-col">
          ...
          <p-table [value]="events()" [scrollable]="true" scrollHeight="flex"
            ...
            <ng-template pTemplate="emptymessage">
              <tr>
                <td colspan="5" class="empty-cell">No events recorded yet</td>
              </tr>
            </ng-template>
          </p-table>
        </div>
        ...
        <div class="svs-card simulator-col">
  ...
  styles: [`
    ...
    .sim-btn {
      ...
      &:hover {
        background: var(--svs-bg-card);
        border-color: var(--svs-accent);
        transform: translateY(-2px);
        box-shadow: var(--svs-shadow-md);
      }
      ...
      &--critical {
        border-left: 3px solid var(--svs-danger);
      }

      &--high {
        border-left: 3px solid var(--svs-critical);
      }
      ...
      &--low {
        border-left: 3px solid var(--svs-text-muted);
      }
    }
