...
@Component({
  ...
  standalone: true,
  imports: [CommonModule, FormsModule, InputTextModule, ButtonModule, ToggleSwitchModule, SliderModule, TagModule, ToastModule, AccordionModule,],
            ...
            <div class="settings-grid">
              ...
              <div class="setting-row">
                ...
                <div class="slider-field">
                  <p-slider [(ngModel)]="settings.poll_interval_ms" (change)="onSettingChange()" [min]="50" [max]="1000"
                            [step]="50"/>
          ...
          <p-accordion-content>
            ...
            <div class="settings-grid">
              <div class="setting-row">
                ...
                <div class="slider-field">
                  <p-slider [(ngModel)]="settings.decision_cycle_ms" (change)="onSettingChange()" [min]="20" [max]="500"
                            [step]="10"/>
              ...
              <div class="setting-row">
                ...
                <div class="slider-field">
                  <p-slider [(ngModel)]="settings.min_display_ms" (change)="onSettingChange()" [min]="500" [max]="10000"
                            [step]="500"/>
              ...
              <div class="setting-row">
                ...
                <div class="slider-field">
                  <p-slider [(ngModel)]="settings.score_threshold" (change)="onSettingChange()" [min]="0" [max]="100"
                            [step]="5"/>
          ...
          <p-accordion-content>
            ...
            <div class="settings-grid">
              <div class="setting-row">
                ...
                <p-toggle-switch [(ngModel)]="settings.obs_enabled" (change)="onSettingChange()"/>
              </div>
              <div class="setting-row">
                <div class="setting-info">
          ...
          <p-accordion-content>
            ...
            <div class="settings-grid">
              <div class="setting-row">
                ...
                <div class="slider-field">
                  <p-slider [(ngModel)]="settings.snapshot_interval_ms" (change)="onSettingChange()" [min]="100"
                            [max]="2000" [step]="100"/>
          ...
          <p-accordion-content>
            ...
            <div class="settings-grid">
              <div class="setting-row">
                ...
                <p-toggle-switch [(ngModel)]="settings.debug" (change)="onSettingChange()"/>
              </div>
              <div class="setting-row">
                <div class="setting-info">
  ...
  styles: [`
    ...
    .setting-row {
      ...
      gap: 2rem;
      padding: 0.75rem 0;
      border-bottom: 1px solid var(--svs-border-subtle);
  ...
  saveSettings(): void {
    ...
    this.api.updateSettings(updates).subscribe({
      next: () => {
        ...
        this.msg.add({
          severity: 'error', summary: 'Save Failed', detail: err.error?.detail || 'Could not save settings'
        });
        this.saving.set(false);
      },
    });
